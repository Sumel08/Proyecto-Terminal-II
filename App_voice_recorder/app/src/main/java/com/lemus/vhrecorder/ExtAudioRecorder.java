...
/**
 * Created by olemu on 14/12/2016.
 */
...
public class ExtAudioRecorder
{
    ...
    public static ExtAudioRecorder getInstance(Boolean recordingCompressed, int sampleRate, String audioFormat)
    {
        ExtAudioRecorder result = null;
        int i = 3;
        switch(sampleRate) {
        ...
        int audioF = AudioFormat.ENCODING_PCM_8BIT;

        if (audioFormat.equals("16"))
            audioF = AudioFormat.ENCODING_PCM_16BIT;
