...
public class WordDetailFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        if (mItem != null) {
            ((TextView) rootView.findViewById(R.id.word_detail)).setText(mItem.details);
            ((ImageView) rootView.findViewById(R.id.wd_image)).setImageBitmap(BitmapFactory.decodeStream(new ByteArrayInputStream(mItem.image)));
        }
